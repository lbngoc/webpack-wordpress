...
const paths = {
  appSrc: resolveApp('src/assets'),
  appBuild: resolveApp('src/build'),
  appIndexJs: resolveApp('src/assets/index.js'),
  appNodeModules: resolveApp('node_modules'),
};

const DEV = process.env.NODE_ENV === 'development';
const PROXY_URL = 'http://' + (process.env.WPSITE_URL ? process.env.WPSITE_URL : 'localhost:9009')
